  ; Ejemplo impresion mapa de 16x16 codificacion scanlines verticales
  ORG 32768
  ...
  LD HL, sokoban1_attr
  LD (DM_ATTRIBS), HL
  LD HL, sokoban_LEVEL1_codif_vert
  LD (DM_MAP), HL
  LD A, 16
  LD (DM_WIDTH), A
  LD A, 12
  ...
  ;;; Impresion de pantalla por codificacion scanlines verticales
...
DrawMap_16x16_Cod_Vert:
   ...
   LD HL, DS_COORD_Y         ; Ahora HL apunta a la variable Y
...
drawm16cv_loop:
   ...
   LD (HL), A                ; Establecemos COORD_Y a imprimir tile
