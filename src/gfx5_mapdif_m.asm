  ; Ejemplo impresion mapa de 16x16 codificacion mixta
  ...
  LD HL, sokoban1_attr
  LD (DM_ATTRIBS), HL
  LD HL, sokoban_LEVEL1_codif_mixta
  LD (DM_MAP), HL
  LD A, 16
  LD (DM_WIDTH), A
  LD A, 12
  ...
  ;;; Impresion de pantalla por codificacion mixta
